...
public class Controller {
    ...
    public void initialize() {
        contacts.add(new Contact("Sawera", "Mushtaq", "sawera.mushtaq_2026@ucentralasia.org", "+97347890", "888248"));
        contacts.add(new Contact("Iqra", "Mir", "iqra.mir@gmail.co", "+194893149", "435499"));
        contacts.add(new Contact("Ali", "Khan", "ali.kahn@gmail.co", "+1948487579", "045346"));
        contacts.add(new Contact("Afsar", "Khan", "afsar.khan@gmail.co", "+194545553", "463789"));
        contacts.add(new Contact("Mushfiq", "Khan", "mushfiq.khan@gmail.co", "+194545555", "463799"));
        contacts.add(new Contact("Abu", "Zar", "abu.zar@gmail.co", "+194585553", "463777"));
